...
module.exports = {
    "matricom": {
        ...
        "update": function (data) {
            ...
            state['button:L2'] = data[7] >> 0 & 1;
            state['button:R2'] = data[7] >> 1 & 1;

            state['button:LB'] = data[7] >> 5 & 1;
            state['button:RB'] = data[7] >> 6 & 1;

            state['axis:JOYL:Y'] = data[2];
            state['axis:JOYL:X'] = data[1];
            state['axis:JOYR:Y'] = data[4];
            state['axis:JOYR:X'] = data[3];

            data[5] = data[5] % 80;
            state['button:N'] =  + (data[5] === 0);
            state['button:NE'] =  + (data[5] === 1);
            state['button:E'] =  + (data[5] === 2);
            state['button:SE'] =  + (data[5] === 3);
            state['button:S'] =  + (data[5] === 4);
            state['button:SW'] =  + (data[5] === 5);
            state['button:W'] =  + (data[5] === 6);
            state['button:NW'] =  + (data[5] === 7);
